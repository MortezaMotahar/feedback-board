...
1. API : خب چون پروژه ساده هست و نیازی به (API) سنگین و پیچیده نیست برای همین از Flask استفاده کردم
...
و خب Bootstrap هم کامپوننت های آماده داشت منم ازش استفاده کردم
